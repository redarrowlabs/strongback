...
function TextFieldStateless(props) {
    var _a = props.input, value = _a.value, onChange = _a.onChange, onBlur = _a.onBlur, onFocus = _a.onFocus, tooltipProps = props.tooltipProps, suffix = props.suffix, prefix = props.prefix, autoComplete = props.autoComplete, multiline = props.multiline, invalid = props.meta.invalid;
...
function TextField(props) {
    var tooltipProps = props.tooltip
        ...
        : null;
    return React.createElement(redux_form_1.Field, { name: props.name, component: TextFieldStateless, autoComplete: props.autoComplete || 'off', label: props.label, onBlur: props.onBlur, multiline: props.multiline, indicator: props.indicator, help: props.help, suffix: props.suffix, prefix: props.prefix, tooltipProps: tooltipProps });
}
